function [H_dropped, n_user_out] = Drop_user_ZF(H, Ptot, channel_norm_input, flag_cell_edge, n_max_drop, flag_Ashkan1_Marzetta0)
[n_user,M_ant] = size(H);
HHH = find_rho_ij(H);
n_user_new = n_user;
...
channel_norm_input_ref = channel_norm_input;
   while flag_correlated_user ==1 && n_user_new >= 2 && n_user_new > n_user - n_max_drop
        ...
        rho_threshold_ZF_current_SNR = find_threshold_ZF_MaxMin_ComLetter_General(Ptot,n_user_new,channel_norm_sorted,flag_cell_edge);
