function [channel_unit_norm,channel_gain,path_loss_dB] = Gen_LOS_Channel_General(M,K,f0_gig,R_max,R_min,...
                    phi_min, phi_max, min_x_spacing, spacing_array)
% Initialization:
...
min_x_spacing = max(lambda,min_x_spacing);
min_y_spacing = max(lambda,min_x_spacing);
